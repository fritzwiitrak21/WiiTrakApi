...
namespace WiiTrakApi.Migrations
{
    ...
    [Migration("20211219210854_RemoveParentIdFromServiceProvider")]
    partial class RemoveParentIdFromServiceProvider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WiiTrakApi.Models.CustomerAccountModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WiiTrakApi.Models.TrackingDeviceDto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WiiTrakApi.Models.DriverModel", b =>
                {
                    b.HasOne("WiiTrakApi.Models.CustomerAccountModel", "CustomerAccount")
                        .WithMany("Drivers")
            ...
            modelBuilder.Entity("WiiTrakApi.Models.TrackingDeviceDto", b =>
                {
                    b.HasOne("WiiTrakApi.Models.AssetModel", "Asset")
                        ...
                        .HasForeignKey("WiiTrakApi.Models.TrackingDeviceDto", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
